                ...
                <div class="card-body p-0 m-0 p-3">
                    ...
                    <div class="mt-3">
                        @foreach($shareCategroies as $c)
                            <a href="{{url('/serie?is_search=y&category='.$c->slug)}}" class="btn btn-sm btn-outline-warning m-1">{{$c->name}}</a>
                        @endforeach
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-0 m-0 p-3">
                    ...
                    <div class="mt-3">
                        <div class="btn btn-outline-primary">
                            <a href="{{url('/serie?is_search=y&rating=abovefive')}}">5 &gt; rating</a>
                        </div>

                        <div class="btn btn-outline-primary">
                            <a href="{{url('/serie?is_search=y&rating=belowfive')}}">5 &lt; rating</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-9">
            <div class="row">
                ...
                @endforeach
                 ...
                 <div class="col-12">
                    <div class="mt-3">
                        {{$latest_series->links('pagination::bootstrap-5')}}
                    </div>
                </div>
